...
export const WelcomeScreen: React.FC<WelcomeScreenProps> = ({ onComplete }) => {
  ...
  const slides: Slide[] = [
    ...
    {
      title: 'کتابخانه هوشمند و همگام‌سازی کتاب‌ها',
      description: 'متون پیاده‌سازی شده همراه با کتاب‌های مرجع و جزوات، دسته‌بندی شده و در کتابخانه هوشمند شما ذخیره می‌شوند تا اطلاعات علمی همواره در دسترس دستیار هوشمند شما باشند.',
      icon: <Database className="w-10 h-10 text-indigo-600" />,
      color: 'text-indigo-600 border-indigo-100/60',
      bgColor: 'bg-indigo-50/60'
    },
    {
      title: 'چت و پاسخ‌دهی دقیق با ارجاع به منبع',
